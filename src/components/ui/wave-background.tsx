...
export function Waves({
    ...
    backgroundColor = "transparent",  // Transparent background to overlay
    pointerSize = 0.5
}: WavesProps) {
    ...
    const setLines = () => {
        ...
        // Use larger spacing for LESS density as requested
        const xGap = 40  // Increased form 8 to 40 for less density
        const yGap = 40  // Increased from 8 to 40 for less density
        ...
        for (let i = 0; i < totalLines; i++) {
            ...
            path.setAttribute('stroke-opacity', '0.1') // Low opacity for subtle background
    ...
    return (
        ...
        >
            ...
            />
            {/* Disabled pointer dot for background usage */}
        </div>
    )
}
