...
export const GalleryContainer = ({
    ...
    const scale = useTransform(scrollYProgress, [0.3, 1], [1.15, 1])

    return (
        <motion.div
            className={cn(
                "relative grid size-full grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 rounded-2xl px-2 sm:px-4",
                className
            )}
            style={{
                rotateX,
